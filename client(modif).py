...
# Ganti 'localhost' dengan IP Mesin 1 
# Sesuaikan port sesuai server yang Anda jalankan di Mesin 1 (8885 atau 8889)
SERVER_IP = '172.16.16.101'
SERVER_PORT = 8885 #jika Anda menjalankan server_thread_pool_http.py
# Atau 8889 jika Anda menjalankan server_process_pool_http.py
